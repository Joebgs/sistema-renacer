...
function AuxiliarDashboard() {
  ...
  const handleDelete = async (id: number) => {
    if (confirm('⚠️ ¿Eliminar esta vendedora? Esta acción no se puede deshacer.')) {
      try {
  ...
  if (loading) return <LayoutAuxiliar title="Panel Auxiliar"><div>Cargando...</div></LayoutAuxiliar>;

  return (
    <LayoutAuxiliar title="Gestión de Vendedoras">
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                ...
                />
                <p className="text-xs text-gray-500 mt-1">Dejar vacío si no tiene gerente asignado</p>
              </div>
